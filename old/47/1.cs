...
class  consleprogram{
    ...
    class magazin:publication{
        ...
        public void print_magazin(){
            base.print_publication();
    ...
    class educational_book:book{
        ...
        public void print_educational_book(){
            base.print_book();
    ...
    static void Main() {
        ...
        publ1.print_publication();
        Console.WriteLine(publ1.age());
        Console.WriteLine();
